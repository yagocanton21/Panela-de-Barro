...
import { Package, Search, Filter, AlertTriangle, Edit2, Trash2, Plus } from "lucide-react";
                            ...
                            <div key={p.id} className="inventory-card" style={{
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.2rem', zIndex: 1 }}>
                                    ...
                                    <div style={{
                                        ...
                                        <span style={{ fontSize: '0.7rem', fontWeight: 'bold', color: status.color }}>{status.label}</span>
                                    </div>
                                </div>

                                {/* Conteúdo Central */}
                                <div style={{ flex: 1, marginBottom: '1.5rem', zIndex: 1 }}>
                                    <h3 style={{
                                        margin: '0 0 8px 0',
                                        fontSize: '1.25rem',
                                        color: 'var(--text-dark)',
