...
async def _test_engine():
    ...
    Usamos StaticPool para SQLite garantir persistência em memória.
    Para PostgreSQL (ex: no GitHub Actions se configurado), usamos NullPool sem check_same_thread.
    """
