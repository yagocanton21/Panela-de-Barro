...
echo "    Bash:       EC2_PUBLIC_IP=${PUBLIC_IP} bash infra/setup-s3-cloudfront.sh"
echo "    PowerShell: \$env:EC2_PUBLIC_IP=\"${PUBLIC_IP}\"; bash infra/setup-s3-cloudfront.sh"
echo ""
echo "  Golden Image (acelerar próximos deploys):"
echo "    Bash:       INSTANCE_ID=${INSTANCE_ID} bash infra/create-ami.sh"
echo "    PowerShell: \$env:INSTANCE_ID=\"${INSTANCE_ID}\"; bash infra/create-ami.sh"
echo ""
